<nav class="bg-gray-500 p-2 flex items-center justify-end ">
  <ul class="flex items-center justify-end">
    <li>
      <a href="/" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Welcome</a>
    </li>
    <li>
    ...
    <li>
      <a href="/test" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Tests</a>
    </li>
    <li>
